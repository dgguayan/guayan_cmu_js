<div class="content-wrapper" style="min-height: 1604.8px;">
        ...
        <div class="row mb-2 justify-content-center">
          ...
          <div class="col-sm-3">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Add Evaluator</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <?php echo form_open('users/add_user_evaluator') ?>
      ...
      <div class="row justify-content-center">
        ...
        <div class="form-group">
          ...
          <select id="roleid" name="roleid" class="form-control custom-select">
                ...
                <?php foreach ($roles as $role) : ?>
                    <option value="<?php echo $role['rolebranch']; ?>" <?php echo ($role['roleid'] == 2) ? 'selected' : ''; ?>>

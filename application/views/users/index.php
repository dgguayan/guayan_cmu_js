<div class="content-wrapper" style="min-height: 1302.4px;">
    ...
    <section class="content-header">
      <div class="container">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Table of Admin</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Table of Users</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                ...
                <h3 class="card-title col-sm-10 align-middle">List of Admins in table.</h3>
                <a type="button" class="btn btn-primary col-sm-2" href="<?php echo base_url('add_user') ?>">Add Admin</a>

  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color: #003b0a">
    ...
    <div class="sidebar">
      ...
      <?php if ($this->session->userdata('userid')) : ?>
        ...
        <?php else : ?>
          <div class="image">
          <img src="<?php echo base_url('assets/upload/uploaded_images/default.jpg')?>" class="img-circle elevation-2" alt="User Image">
        </div>
        <?php endif; ?>
        <div class="info">
        <?php if ($this->session->userdata('userid')) : ?>
            <a href="<?php echo base_url('user_detail_general/' . $this->session->userdata('userid')); ?>" class="d-block">
